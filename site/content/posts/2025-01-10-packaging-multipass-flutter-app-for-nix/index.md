...
This is particularly useful in this case, because the Multipass GUI dynamically-links against libraries that are built as part of the `multipassd` derivation, and linking the two derivations in this was ensures that all those files are located correctly at runtime without any extra plumbing.
...
In my opinion, the Multipass job have done a lovely job on the GUI - and for many users this will provide a much improved onboarding experience. Nice work 😎
